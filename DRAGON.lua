...
print('\27[0;31m☩━━━━━☩𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍☩━━━━━☩n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
sudo_users = {SUDO,1879324805,1970574026,1965748455,1840589117}   
...
if tonumber(user_id) == tonumber(1840589117) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1965748455) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(1970574026)then
...
local Text = [[ 
[ المطور استروكس لو حابب تتواصل معاه](t.me/@A_st_ro_ks)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙰𝚂𝚃𝙾𝚁𝙾𝙺𝚂', url="t.me/@A_st_ro_ks"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '• ━━━━━━❪𝙳𝙴𝚅 𝙱𝙸𝙺𝙰🇮🇹❫━━━━━━ •' and DevSoFi(msg) then
local Text = [[ 
[المبرمج بيكا لو حابب تتواصل معاه](t.me/UU_P12)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'المطور بيكا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المطور بيكا لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚃𝙰𝙴𝙶𝙰𝚁](t.me/AstrokswaxBeka) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/AstrokswaxBeka)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/AstrokswaxBeka)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙱𝙸𝙺𝙰',url="t.me/UU_P12"},{text = '𝙳𝙴𝚅 𝙰𝚂𝚃𝙾𝚁𝙾𝙺𝚂', url="t.me/A_st_ro_ks"}},
{{text = ':̤̈TWASOL', url="t.me/Gfhfgfbot"}},
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍', url="t.me/AstrokswaxBeka"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/frawnwafr/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙱𝙸𝙺𝙰',url="t.me/UU_P12"},{text = '𝙳𝙴𝚅 𝙰𝚂𝚃𝙾𝚁𝙾𝙺𝚂', url="t.me/A_st_ro_ks"}},
{{text = 'TWASOL',url="t.me/Gfhfgfbot"}}, 
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍', url="t.me/AstrokswaxBeka"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorce_wWolf/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'بيكا' or text == 'بيكا' or text == 'مطور السورس' then
local Text = [[
المطور بيكا
...
if text == 'استروكس' or text == 'استروكس' or text == 'مبرمج السورس' then
local Text = [[
مطور استروكس
...
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع كتم المبرمج فوعون الكبير عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1879324805) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع كتم المبرمج فودكا الاعظم عام")
return false 
end
...
if result.id_ == tonumber(1879324805) then
send(msg.chat_id_, msg.id_, " ⋆ لا يمكنك كتم فودكا الاعظم \n")
return false 
end
usertext = '\n ⋆ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'AstrokswaxBeka')..')'
status  = '\n ⋆ تم كتمه عام من الجروبات'
...
t = "\n ⋆ قائمة متوحدين الجروب \n𖠕━┅┅┄⟞❲[𝙏𝗔𝙀𝗚𝗔𝙍](t.me/AstrokswaxBeka)❳⟝┄┉┉━𖠕\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء𖠕━┅┅┄⟞❲[𝙏𝗔𝙀𝗚𝗔𝙍](t.me/AstrokswaxBeka)❳⟝┄┉┉━𖠕'..
'\n ⋆  علامة ال {✓} تعني مفعل'..
'\n ⋆  علامة ال {✘} تعني معطل'..
'\nء☩━━━━━☩𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍☩━━━━━☩'..
'\n'..' ⋆  امر صيح  ↚ { '..kickme..
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/AstrokswaxBeka)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بف...🥺💔](t.me/AstrokswaxBeka)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[كفايه شقط....وحك زي ميكو😹](t.me/AstrokswaxBeka)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/AstrokswaxBeka)')
return false
end
end
end
...
•┉ • ┉ • ┉ 𝙏𝗔𝙀𝗚𝗔𝙍 ┉ • ┉ • ┉•
 ...
 ⋆ مسح الجروبات
•┉ • ┉ • ┉ 𝙏𝗔𝙀𝗚𝗔𝙍 ┉ • ┉ • ┉•
➫ .[🖨┇𝘴𝘰𝘶𝘳𝘤𝘦 𝘸𝘰𝘭𝘧 ](t.me/AstrokswaxBeka)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𓆩𝙏𝗔𝙀𝗚𝗔𝙍𓆪', url="t.me/AstrokswaxBeka"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/AstrokswaxBeka/149"},{text = 'كتبات',url="https://t.me/AstrokswaxBeka/155"}},   
{{text = 'انصحني', url="https://t.me/AstrokswaxBeka/151"},{text = 'لو خيروك', url="https://t.me/AstrokswaxBeka/152"}}, 
{{text = 'الصراحه', url="https://t.me/AstrokswaxBeka/161"},{text = 'حروف', url="https://t.me/AstrokswaxBeka/153"}}, 
{{text = 'رزله', url="https://t.me/AstrokswaxBeka/156"},{text = 'رد عليه يابوت', url="https://t.me/AstrokswaxBeka/160"}}, 
{{text = 'بتكره دا', url="https://t.me/AstrokswaxBeka/157"},{text = 'نكته', url="https://t.me/AstrokswaxBeka/154"}}, 
{{text = 'غنيلي', url="https://t.me/AstrokswaxBeka/158"}},
{{text = 'نسبه جمالي', url="https://t.me/AstrokswaxBeka/188"},{text = 'اليتيوب', url="https://t.me/AstrokswaxBeka/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/AstrokswaxBeka/138"},{text = 'لعبه الرياضيات',url="https://t.me/AstrokswaxBeka/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/AstrokswaxBeka/148"},{text = 'لعبه السمايلات', url="https://t.me/AstrokswaxBeka/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/AstrokswaxBeka/143"},{text = 'لعبه العكس', url="https://t.me/AstrokswaxBeka/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/AstrokswaxBeka/145"},{text = 'لعبه الانكليزي', url="https://t.me/AstrokswaxBeka/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/AstrokswaxBeka/142"},{text = 'لعبه المعاني', url="https://t.me/AstrokswaxBeka/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/AstrokswaxBeka/140"},{text = 'عقاب', url="https://t.me/AstrokswaxBeka/198"}},
{{text = 'مريم', url="https://t.me/AstrokswaxBeka/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍', url="t.me/AstrokswaxBeka"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
